...
In the ".py" files each section is divided through commented titles while in the pdfs all new secction start with the first column of HackerrankSubmission (Problem, Language, Score)
